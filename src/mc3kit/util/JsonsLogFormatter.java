...
public class JsonsLogFormatter extends java.util.logging.Formatter {
	...
	public String format(LogRecord r) {
		Map<String, Object> map = makeMap("date",
				new Date(r.getMillis()).toString(), "logger",
				r.getLoggerName(), "class", r.getSourceClassName(), "level", r
						.getLevel().toString(), "message", r.getMessage());

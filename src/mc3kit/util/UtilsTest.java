...
public class UtilsTest {
	...
	public void flatMap() throws MC3KitException {
		Map<String, Object> flatMap = makeMap("key1", 2, "key2", new double[] {
				5, 4, 3 }, "key3", new LinkedHashMap<String, Object>());
		assertEquals(2, flatMap.get("key1"));
		assertArrayEquals(new double[] { 5, 4, 3 },
				(double[]) flatMap.get("key2"), 0.0);
	...
	public void oneLevelHMap() throws Exception {
		Map<String, Object> flatMap = makeMap("0.mean", 4.5, "0.prec", 4.5,
				"0.name", "zero");

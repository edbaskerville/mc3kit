...
public abstract class Variable extends ModelNode {
  ...
  public Object toDbValue() throws MC3KitException {
	  throw new UnsupportedOperationException(format("Variable %s doesn't support db output.", this));
  }
  
  public void loadFromDbValue(Object value) throws MC3KitException {
	  throw new UnsupportedOperationException(format("Variable %s doesn't support db loading.", this));
  }

...
public class ExponentialDistribution extends DoubleDistribution {
	...
	public ExponentialDistribution setRate(DoubleValued rateNode)
	...
	public ExponentialDistribution setScale(DoubleValued scaleNode)
			throws MC3KitException {
	...
	public double getLogP(Variable v) {
		...
		if(scaleEdge != null) {
			...
			return getLogPRate(x, rateEdge == null ? rate
					: getDoubleValue(rateEdge));
		}
	}

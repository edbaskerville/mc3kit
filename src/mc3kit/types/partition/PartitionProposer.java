...
public class PartitionProposer extends VariableProposer {
	...
	private void stepAllowingEmpty(Model model, Chain chain, RandomEngine rng,
		...
		for(int i : order) {
			...
			boolean accepted = shouldAcceptMetropolisHastings(rng,
					...
					oldLogLikelihood, newLogPrior, newLogLikelihood, 0.0);
	...
	private void stepNoEmpty(Model model, Chain chain, RandomEngine rng,
			PartitionVariable var) throws MC3KitException {
